import 'package:quizzy_mobile_app/studentlogin.dart';
import 'package:quizzy_mobile_app/teacherlogin.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            const SizedBox(height: 30), // Slight spacing before slogans
            Container(
            ...
            Transform.translate(
              offset: const Offset(0, -20), // Move the image up
              child: Image.network(
            ...
            Container(
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center, // Align buttons closer
                children: [
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
