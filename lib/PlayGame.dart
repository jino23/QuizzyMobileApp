import 'package:quizzy_mobile_app/StudentDashBoard.dart';
...
class _PlayGameState extends State<PlayGame> {
  ...
  // We tried using HTTP requests to fetch the questions from the hosted game and display it to the student, however it did not work.
  // Future<List<Map<String, dynamic>>> _fetchQuestions() async {
  //   final url = Uri.parse('https://apiendpoint.com/api/questions/${widget.gameId}');
